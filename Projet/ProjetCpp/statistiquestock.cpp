#include "statistiquestock.h"
#include "ui_statistiquestock.h"
#include <QtSql>
#include<QMap>
#include <iostream>
#include <QString>
...
statistiquestock::statistiquestock(QWidget *parent) :
    QMainWindow(parent),
    ui(new Ui::statistiquestock)
{
    ui->setupUi(this);
    // set dark background gradient:
               ...
               regen->setName("nombre d'abonnes");
               ...
               ticks << 1 << 2 << 3 << 4 << 5 ;
               QSqlQuery q;
           q.prepare("select etage ,count(id_abonne)as somme from place_parking group by etage ");
               ...
               ui->widget->xAxis->setLabel("etage");
...
statistiquestock::~statistiquestock()
{
    delete ui;
}
