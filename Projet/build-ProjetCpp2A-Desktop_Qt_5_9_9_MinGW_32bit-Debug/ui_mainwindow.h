...
"}"));
        ...
        tabWidget->setGeometry(QRect(370, 130, 781, 641));
...
"}"));
        ...
        tabWidget_2->setGeometry(QRect(0, 0, 731, 581));
        tab_3 = new QWidget();
        ...
        label_8->setGeometry(QRect(200, 450, 101, 21));
        ...
        TRI_2->setGeometry(QRect(630, 50, 131, 41));
