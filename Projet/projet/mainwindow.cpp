...

{
    ...
    media->setMedia( QUrl::fromLocalFile("C:/Users/Fadwa/Desktop/Projet c++ - Copie executable/ProjetCppA23G2/brave.mp3"));
    media->play();
...
/*void MainWindow::on_msgLDC_clicked()
{
    QString text=ui->lineEdit_envmsg->text();
    A.write_to_arduino("#TEXT"+text+"#\n");
}*/
