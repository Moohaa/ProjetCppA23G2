...
void notification::notification_modifier()
{
    ...
    notifyIcon->setIcon(QIcon("C:/Users/PC/Desktop/ProjetCppA23G2/ProjetCpp/ProjetCpp/koujinti.png"));
    notifyIcon->show();
    notifyIcon->showMessage("Stock modifiee","Un nouveau stock a été modifié ",QSystemTrayIcon::Warning,15000);
}
...
void notification::stock_manquant()
{
      ...
      notifyIcon->setIcon(QIcon("C:/Users/PC/Desktop/ProjetCppA23G2/ProjetCpp/ProjetCpp/hat.png"));
      notifyIcon->show();
...
void notification::stock_exces()
{
    ...
    notifyIcon->setIcon(QIcon("C:/Users/PC/Desktop/ProjetCppA23G2/ProjetCpp/ProjetCpp/hat.png"));
    notifyIcon->show();
    notifyIcon->showMessage("Stock supprimee","Un nouveau stock a été supprimé ",QSystemTrayIcon::Critical,15000);
}
